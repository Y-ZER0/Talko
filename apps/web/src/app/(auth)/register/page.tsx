  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-bg p-4">
      <div className="flex flex-col items-center mb-8">
        ...
        <h1 className="text-2xl font-semibold text-text m-0">Create your account</h1>
        <p className="text-sm text-text-muted m-2">Join Talko and start messaging</p>
      </div>
      ...
      <p className="text-sm text-text-muted mt-6">
        ...
        <a href="/login" className="text-primary-500 font-medium no-underline hover:text-primary-600">
          Sign in
        </a>
      </p>
    </div>
